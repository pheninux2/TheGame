...
COPY --from=build /app/target/TheCardGame-0.0.1-SNAPSHOT.jar TheGame.jar
...
CMD ["sh", "-c", "java -cp h2.jar org.h2.tools.Server -tcp -tcpAllowOthers & sleep 5 && java -jar TheGame.jar"]